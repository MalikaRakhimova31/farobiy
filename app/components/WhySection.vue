  ...
  >
    ...
    <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
      <div
        ...
        :key="groupIndex"
        class="group dark:bg-dark-400 dark:border-dark-50 animate-slide-up rounded-2xl border border-transparent bg-white p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:border-[#009663]/20 hover:shadow-xl"
