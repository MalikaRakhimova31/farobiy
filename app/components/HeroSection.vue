<template>
  <section id="hero" class="relative pt-24 lg:pt-32 pb-16 lg:pb-24 overflow-hidden bg-linear-to-br from-primary-50 via-white to-green-50">
    <!-- Background Pattern -->
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            />
            <!-- Overlay decoration -->
            <div class="absolute inset-0 bg-linear-to-t from-primary-900/30 to-transparent"></div>
          </div>
